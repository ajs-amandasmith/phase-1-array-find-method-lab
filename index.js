...
//   const result = findElement ? findElement.year : undefined;
//   console.log(result);
//   return result;
// }
...
function superbowlWin(array) {
  ...
  const result = array.find(isTrue);
  return result ? result.year : undefined;
}

console.log(superbowlWin(record));

// .find() is a method that is attached to an array and takes in a function
// 
